...
import { CreateMascotaDto } from 'src/interface/ICreateMascotaDTO';
...
const FormularioRegistroMascota: React.FC = () => {
  ...
  const handleArrayChange = (e: React.ChangeEvent<HTMLTextAreaElement>, key: keyof CreateMascotaDto) => {
